...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($new_name) && !empty($new_email)) {
        ...
        if ($updateStmt->execute([$new_name, $new_email, $new_bio, $profile_pic, $new_birthdate, $new_gender, $user_id])) {
            ...
            $user['name'] = $new_name; $user['email'] = $new_email; $user['bio'] = $new_bio; $user['profile_pic'] = $profile_pic; $user['birthdate'] = $new_birthdate; $user['gender'] = $new_gender;
        }
    } else { $message = "Name and Email are required."; }
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="profile-card">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="profile-img-container">
                <img src="uploads/profile_pics/<?php echo e($user['profile_pic'] ?? 'default.png'); ?>" class="profile-img-preview">
            ...
            <input type="date" name="birthdate" value="<?php echo e($user['birthdate'] ?? ''); ?>">
            <label>Gender</label>
            <select name="gender">
